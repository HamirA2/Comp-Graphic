...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// callback used for receiving mouse wheel scroll events
...
// scroll callback for changing camera movement speed
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// added upward and downard camera movement for keys Q and E respectively
	...
	// added O key to change view from perspective to orthographic side view
	...
	// added P key to change view from orthographic to perspective
...
void ViewManager::PrepareSceneView()
{
	...
	else
	{
		...
		// orthographic projection based on the aspect ratio
